            ...
            <footer class="mt-5 py-5">
                <div class="row container mx-auto pt-5">
                    <div class="footer-one col-lg-3 col-md-6 col-sm-12">
                        <img class="footer-brand" src="assets/img/logo.png" alt="">
                        <p class="pt-3">We provide best products for the most </br> affordable prices</p>
                    </div>
                    <div class="footer-one col-lg-3 col-md-6 col-sm-12">
                ...
                <p class="mt-3 text-light ml-5">Devoloperd by Software Engneering - UOK</p>
            </footer>
